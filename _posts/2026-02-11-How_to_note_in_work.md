...
* クリックした位置に文字が入力される
    ...
    * カーソルの位置を見失う
* コピペで体裁が崩れる
    * <strike>議事録をメールで送りたいのに、Outlookへコピペしたら箇条書きの点の位置が変になる</strike>
...
* 箇条書きの階層化がインデントだけで出来てしまう。深い箇条書きになって、客観的に分かりにくい文書になる。<br><br>

また、メールでの共有はコピペが面倒だ。議事録などはOneNoteで取って、勉強や自分の業務整理はVS Notesを使っている。<br>
