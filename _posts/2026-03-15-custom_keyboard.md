...
CCやMCUとの接続は問題がなさそうなので、クロックに問題があるかもしれない。<br>「crystal-lessの力を過信したな」と言われてる気がした。（百錬三郎）<br>ただ、PCBにテストピンを付けていないので、オシロスコープでクロック波形を観察するのが面倒だった。この検証は後回しにしよう。<br>
